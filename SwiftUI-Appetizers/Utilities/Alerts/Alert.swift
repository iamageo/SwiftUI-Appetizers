...
struct AlertContext {
    ...
    static let unableToComplete = AlertItem(title: Text("Server Error"), message: Text("Unable to complete your request as this time. Please check your internet connection."), dismissButton: .default(Text("OK")))
